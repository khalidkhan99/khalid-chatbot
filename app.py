...
LIVE_KEYWORD_PATTERN = re.compile(
    r"\b(" + "|".join(LIVE_KEYWORDS) + r")\b", re.IGNORECASE
)
...
# Page ko turant sab se naye (aakhri) message tak scroll kar dete hain,
# taake purani history upar rahe lekin screen khulte hi last sawal/jawab dikhe.
